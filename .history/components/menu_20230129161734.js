...
export default function Menu() {
    ...
    return <><div style={{ display: 'flex', width: '100%', justifyContent:'space-between', position:'fixed', marginLeft:'8%', marginRight:'8%' }}>
        <img src="/icons/menu-icon.png" onClick={handleClickMenu} style={{ display:'flex', height: 30, width: 30, top: 0, left: 0, margin: 10 }} />
