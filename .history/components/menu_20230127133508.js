...
export default function Menu() {
    ...
    <div style={{ display: showMenu ? 'flex' : 'none', position:'fixed', top:50, left:20, justifyContent:'center'}}>
            <img src='/background-images/menuBackground.png' style={{height:250, width:250, position:'absolute', top:-50, left:10}}/>
